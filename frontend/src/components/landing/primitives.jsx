/**
 * Primitivos usados na landing:
 *  - Wordmark  → marca MedFlow (header/footer)
 *  - GoogleG   → ícone SVG do botão "Entrar com Google"
 */

export const Wordmark = ({ dark = false }) => (
  <div className="flex items-center gap-2.5" data-testid="wordmark">
    <img
      src="/brand/medflow-symbol.png"
      alt="Símbolo MedFlow"
    ...
    <span
      ...
      style={{ color: dark ? '#FFFFFF' : 'var(--mf-inst-ink)', letterSpacing: '-0.015em' }}
    >
      <span>MedFlow</span>
    </span>
  </div>
